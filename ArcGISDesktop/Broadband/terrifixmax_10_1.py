...
# Process: select 10/1 wireline
arcpy.Select_analysis(plss, "wirelineSelect", "MAXADDOWN >= 10 AND MAXADUP >=  1 AND ENDUSERCAT <> '2'")
arcpy.AddMessage("Selected all wireline meeting 10mbps download and 1mbps upload.")

# Process: select 10/1 fixed wireless
arcpy.Select_analysis(wireless, "wirelessSelect", "TRANSTECH BETWEEN 70 AND 71 AND MAXADDOWN >= 10 AND MAXADUP >=  1 AND ENDUSERCAT <> '2'")
arcpy.AddMessage("Selected all wireless meeting 10mbps download and 1mbps upload.")
