...
arcpy.AddMessage("Selected all wireline meeting 25mbps download and 3mbps upload.")
...
arcpy.AddMessage("Selected all wireless meeting 25mbps download and 3mbps upload.")
