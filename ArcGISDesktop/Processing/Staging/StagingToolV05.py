...
if roads == '#' or not roads:
    roads = "C:\\Users\\fischerw\\GOIT\\ArcGISTool\\Working\\StGISTool\\mockGDB.gdb\\TWT_roads" # provide a default value if unspecified

midmile = arcpy.GetParameterAsText(5)
if midmile == '#' or not midmile:
    midmile = "C:\\Users\\fischerw\\GOIT\\ArcGISTool\\Working\\StGISTool\\mockGDB.gdb\\TWT_midmile" # provide a default value if unspecified

wireless = arcpy.GetParameterAsText(6)
if wireless == '#' or not wireless:
    wireless = "C:\\Users\\fischerw\\GOIT\\ArcGISTool\\Working\\StGISTool\\mockGDB.gdb\\strata_wireless" # provide a default value if unspecified

address = arcpy.GetParameterAsText(7)
if address == '#' or not address:
    address = "P:\\SBDDGP-ARRA Project\\BroadbandProductionArea\\Workspaces\\2012October_StagingArea\\level3.gdb\\address" # provide a default value if unspecified
...
# Process: Append (2)
arcpy.Append_management("C:\\Users\\fischerw\\GOIT\\ArcGISTool\\Working\\StGISTool\\mockGDB.gdb\\TWT_roads", "roads", "NO_TEST", "", "")
...
# Process: Append (3)
arcpy.Append_management("C:\\Users\\fischerw\\GOIT\\ArcGISTool\\Working\\StGISTool\\mockGDB.gdb\\TWT_midmile", "midmile", "NO_TEST", "", "")
...
# Process: Append (4)
arcpy.Append_management("C:\\Users\\fischerw\\GOIT\\ArcGISTool\\Working\\StGISTool\\mockGDB.gdb\\strata_wireless", "wireless", "NO_TEST", "", "")
...
# Process: Append (5)
arcpy.Append_management("'P:\\SBDDGP-ARRA Project\\BroadbandProductionArea\\Workspaces\\2012October_StagingArea\\level3.gdb\\address'", "address", "NO_TEST", "", "")
